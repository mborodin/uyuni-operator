...
internal/cobbler/            # Cobbler XMLRPC client (Uyuni's /cobbler_api)
  xmlrpc.go                  # Dependency-free XMLRPC codec
  client.go                  # Reads (unauth) + writes (token via login); systems/profiles/distros
